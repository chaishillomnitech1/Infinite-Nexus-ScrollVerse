...
class EinsteinAICompanion {
  constructor(config = {}) {
    ...
    this.corePhilosophy = {
      ...
      humanity: 'Peace cannot be kept by force; it can only be achieved by understanding.',
      wonder: 'The most beautiful thing we can experience is the mysterious. It is the source of all true art and science.'
    };
  ...
  generateQuiz(topic, difficulty = 'medium') {
    const quizzes = {
        ...
        easy: [
          {
            ...
            correct: 0,
            explanation: 'Einstein showed that energy and mass are different forms of the same thing. They can be converted into each other.'
          }
        ],
        medium: [
          {
            ...
            correct: 1,
            explanation: 'The constancy of light speed is a fundamental principle of special relativity, arising from the structure of spacetime itself.'
          }
        ],
        hard: [
          {
      ...
      curiosity: {
        easy: [
          {
            question: 'According to Einstein, what is more important than knowledge?',
            options: [
              'Intelligence',
              'Imagination',
              'Memory',
            ...
            correct: 1,
            explanation: 'Einstein believed imagination is more important than knowledge, because imagination embraces the entire world while knowledge is limited.'
          }
        ]
      }
    };
    ...
    return {
      ...
      einsteinEncouragement: 'Remember, the important thing is not to stop questioning!'
    };
  }
  ...
  createThoughtExperiment(concept) {
    const experiments = {
      relativity: {
        ...
        scenario: 'Imagine you\'re on a train moving at nearly the speed of light. Lightning strikes both ends of the train simultaneously from the platform\'s perspective.',
        question: 'Do you see the lightning strikes at the same time from inside the train?',
        answer: 'No! Due to time dilation and the relativity of simultaneity, events that appear simultaneous in one reference frame may not be simultaneous in another.',
        insight: 'This demonstrates that time is not absolute - it\'s relative to the observer\'s motion.',
        visualization: 'Imagine the train car with light rays traveling from both ends toward the middle'
      },
      quantum_mechanics: {
        title: 'Einstein\'s Photon Box',
        scenario: 'A box contains a single photon. We know its energy precisely by measuring the time it takes to escape.',
        question: 'Can we know both the energy and time of the photon with perfect precision?',
        answer: 'No! Heisenberg\'s uncertainty principle tells us we cannot know both with arbitrary precision.',
        insight: 'Einstein used this thought experiment to challenge quantum mechanics, leading to deeper understanding of the theory.',
        visualization: 'A sealed box with a shutter that opens briefly to release a photon'
      },
      space_time: {
        title: 'The Elevator Experiment',
        scenario: 'You\'re in a closed elevator with no windows. The elevator could be at rest on Earth or accelerating in space.',
        question: 'Can you tell the difference between gravity and acceleration?',
        answer: 'No! This is the principle of equivalence - gravity and acceleration are indistinguishable.',
        insight: 'This led Einstein to realize that gravity must curve spacetime itself.',
        visualization: 'An elevator floating in space accelerating upward'
      }
    };
    
    return experiments[concept] || {
      title: 'The Curious Mind',
      scenario: 'Einstein once said, "If I had an hour to solve a problem, I\'d spend 55 minutes thinking about the problem and 5 minutes thinking about solutions."',
      question: 'Why is understanding the problem so important?',
      answer: 'Because truly understanding the problem often reveals the solution. The right question is half the answer.',
      insight: 'Deep thinking about fundamentals is more valuable than rushing to solutions.',
    ...
    const lessons = {
      relativity: {
        beginner: {
          ...
          content: 'Relativity teaches us that space and time are not separate, but form a unified spacetime. What seems obvious at slow speeds becomes strange at speeds approaching light.',
          keyPoints: [
          ...
          practicalExample: 'GPS satellites must account for time dilation - time runs slightly faster in space than on Earth!',
          nextSteps: ['Study time dilation', 'Explore spacetime diagrams', 'Learn about gravitational waves']
        },
        intermediate: {
          title: 'Special Relativity Deep Dive',
          content: 'Special relativity emerges from two postulates: the laws of physics are the same in all inertial frames, and the speed of light is constant.',
          keyPoints: [
          ...
          practicalExample: 'Muons from cosmic rays reach Earth\'s surface due to time dilation - they live longer in our reference frame.',
          nextSteps: ['Calculate Lorentz factor', 'Study four-vectors', 'Explore spacetime intervals']
        }
      },
      curiosity: {
        beginner: {
          title: 'The Power of Curiosity',
          content: 'Einstein\'s greatest gift wasn\'t his intelligence - it was his curiosity. He asked questions others didn\'t think to ask.',
          keyPoints: [
          ...
          practicalExample: 'Einstein wondered what it would be like to ride alongside a light beam - this led to special relativity!',
          nextSteps: ['Ask "why" five times about something you take for granted', 'Find wonder in everyday phenomena', 'Keep a curiosity journal']
        }
      }
    };
  ...
  _generateResponse(userInput) {
    ...
    if (input.includes('relativity') || input.includes('time') || input.includes('space')) {
    ...
    if (input.includes('curiosity') || input.includes('question') || input.includes('wonder')) {
    ...
    if (input.includes('imagination') || input.includes('creative') || input.includes('idea')) {
    ...
    if (input.includes('problem') || input.includes('solve') || input.includes('stuck')) {
  ...
  _findRelatedConcepts(userInput) {
    ...
    if (input.includes('light')) {
      concepts.push('photons', 'wave-particle duality', 'speed of light', 'electromagnetic radiation');
    }
    if (input.includes('energy')) {
      concepts.push('E=mc²', 'mass-energy equivalence', 'conservation laws', 'kinetic energy');
    }
    
    if (concepts.length === 0) {
      concepts.push('curiosity', 'imagination', 'problem solving', 'scientific method');
    }
  ...
  _suggestVisualization(userInput) {
    return {
      ...
      description: 'A diagram showing how different observers see events in spacetime',
      interactive: true
    };
  }
  ...
  _suggestTopics(knowledgeLevel) {
    const topics = {
      beginner: ['curiosity', 'imagination', 'simple_relativity', 'light_and_energy'],
      intermediate: ['special_relativity', 'time_dilation', 'E=mc²', 'thought_experiments'],
      advanced: ['general_relativity', 'spacetime_curvature', 'gravitational_waves', 'cosmology']
    };
  ...
  _getRelevantQuote(topic) {
    const quotes = {
      relativity: 'When you sit with a nice girl for two hours you think it\'s only a minute, but when you sit on a hot stove for a minute you think it\'s two hours. That\'s relativity.',
      curiosity: 'The important thing is not to stop questioning. Curiosity has its own reason for existing.',
      imagination: 'Imagination is more important than knowledge. Knowledge is limited. Imagination encircles the world.',
